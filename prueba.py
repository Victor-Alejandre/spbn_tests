...
for k in range(9, 10):
    ...
    SPBNetwork_nr_G_0 = x.estimate(operators=operators, score=pb.ValidatedLikelihood(sample, seed=10, k = 5),
    ...
    x = pb.GreedyHillClimbing()
    SPBNetwork_nr_G_1 = x.estimate(operators=operators, score=pb.ValidatedLikelihood(sample, seed=10, k = 5),
    ...
    x = pb.GreedyHillClimbing()
    SPBNetwork_ucv_G_0 = x.estimate_wbm(operators=operators, score=pb.ValidatedLikelihood(sample, seed=10, k = 5),
    ...
    x = pb.GreedyHillClimbing()
    SPBNetwork_ucv_G_1 = x.estimate_wbm(operators=operators, score=pb.ValidatedLikelihood(sample, seed=10, k = 5),
    ...
    print(results)
    results.to_csv('results_exp_1_hc_2000_parte4.csv')
