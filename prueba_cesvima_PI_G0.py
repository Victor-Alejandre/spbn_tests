...
for k in range(5, 6):
    ...
    SPBNetwork_PI_G_0 = x.estimate_wbm(operators=operators, score=pb.ValidatedLikelihood(sample, seed=10, k = 5),
    ...
    result_SP_PI_G_0.append(structural_hamming_distance(pb.Dag(SPBNetwork_PI_G_0.nodes(), SPBNetwork_PI_G_0.arcs()).to_pdag(), pb.Dag(ground_truth_network.nodes(),ground_truth_network.arcs()).to_pdag()))
