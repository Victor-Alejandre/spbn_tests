...
for k in range(0, 1):
    ...
    SPBNetwork_PI_G_1 = x.estimate_wbm(operators=operators, score=pb.ValidatedLikelihood(sample, seed=10, k = 5),
    ...
    result_SP_PI_G_1.append(structural_hamming_distance(pb.Dag(SPBNetwork_PI_G_1.nodes(), SPBNetwork_PI_G_1.arcs()).to_pdag(), pb.Dag(ground_truth_network.nodes(),ground_truth_network.arcs()).to_pdag()))
    ...
    print(results)
    results.to_csv('results_exp_1_PI_G0_10000_0.csv')