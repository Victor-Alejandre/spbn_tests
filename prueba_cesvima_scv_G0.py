...
for k in range(0, 1):
    ...
    result_SP_scv_G_0.append(structural_hamming_distance(pb.Dag(SPBNetwork_scv_G_0.nodes(), SPBNetwork_scv_G_0.arcs()).to_pdag(), pb.Dag(ground_truth_network.nodes(),ground_truth_network.arcs()).to_pdag()))  
